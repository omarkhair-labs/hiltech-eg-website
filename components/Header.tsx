...
export default function Header() {
  ...
  const isCreativePublic = pathname === '/' || pathname.startsWith('/solutions') || pathname.startsWith('/services') || pathname.startsWith('/products-partners') || pathname.startsWith('/work');
